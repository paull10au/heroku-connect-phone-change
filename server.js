        ...
        conn.query(
            ...
            function(err, result) {
                ...
                if (err != null || result.rowCount == 0) {
                  ...
                  [phoneNumber, phoneNumber, phoneNumber, req.body.firstName.trim(), req.body.lastName.trim(), req.body.email.trim()],
                  function(err, result) {
                    done();
                    if (err) {
                        ...
                        // this will still cause jquery to display 'Record updated!' even though it was inserted.
                        res.json(result);
                    }
                  });
                }
